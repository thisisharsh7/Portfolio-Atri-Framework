...
class Atri:
	def __init__(self, state: Any):
		...
		self.Link137 = state["Link137"]
		self.Link138 = state["Link138"]
		self.Link139 = state["Link139"]
		self.Link140 = state["Link140"]
		self.Link136 = state["Link136"]
	...
	@property
	def Link104(self):
		self._getter_access_tracker["Link104"] = {}
		return self._Link104
	@Link104.setter
	def Link104(self, new_state):
		self._setter_access_tracker["Link104"] = {}
		global default_state
		self._Link104 = Link(new_state, default_state["Link104"])
	...
	@property
	def Link137(self):
		self._getter_access_tracker["Link137"] = {}
		return self._Link137
	@Link137.setter
	def Link137(self, new_state):
		self._setter_access_tracker["Link137"] = {}
		global default_state
		self._Link137 = Link(new_state, default_state["Link137"])

	@property
	def Link138(self):
		self._getter_access_tracker["Link138"] = {}
		return self._Link138
	@Link138.setter
	def Link138(self, new_state):
		self._setter_access_tracker["Link138"] = {}
		global default_state
		self._Link138 = Link(new_state, default_state["Link138"])

	@property
	def Link139(self):
		self._getter_access_tracker["Link139"] = {}
		return self._Link139
	@Link139.setter
	def Link139(self, new_state):
		self._setter_access_tracker["Link139"] = {}
		global default_state
		self._Link139 = Link(new_state, default_state["Link139"])

	@property
	def Link140(self):
		self._getter_access_tracker["Link140"] = {}
		return self._Link140
	@Link140.setter
	def Link140(self, new_state):
		self._setter_access_tracker["Link140"] = {}
		global default_state
		self._Link140 = Link(new_state, default_state["Link140"])

	@property
	def Link136(self):
		self._getter_access_tracker["Link136"] = {}
		return self._Link136
	@Link136.setter
	def Link136(self, new_state):
		self._setter_access_tracker["Link136"] = {}
		global default_state
		self._Link136 = Link(new_state, default_state["Link136"])
	...
	def _to_json_fields(self):
		return {
			...
			"Link137": self._Link137,
			"Link138": self._Link138,
			"Link139": self._Link139,
			"Link140": self._Link140,
			"Link136": self._Link136,
