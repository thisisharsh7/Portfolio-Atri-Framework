...
class Atri:
	def __init__(self, state: Any):
		...
		self.Link147 = state["Link147"]
		self.Link148 = state["Link148"]
		self.Link149 = state["Link149"]
		self.Link150 = state["Link150"]
	...
	@property
	def Link147(self):
		self._getter_access_tracker["Link147"] = {}
		return self._Link147
	@Link147.setter
	def Link147(self, new_state):
		self._setter_access_tracker["Link147"] = {}
		global default_state
		self._Link147 = Link(new_state, default_state["Link147"])

	@property
	def Link148(self):
		self._getter_access_tracker["Link148"] = {}
		return self._Link148
	@Link148.setter
	def Link148(self, new_state):
		self._setter_access_tracker["Link148"] = {}
		global default_state
		self._Link148 = Link(new_state, default_state["Link148"])

	@property
	def Link149(self):
		self._getter_access_tracker["Link149"] = {}
		return self._Link149
	@Link149.setter
	def Link149(self, new_state):
		self._setter_access_tracker["Link149"] = {}
		global default_state
		self._Link149 = Link(new_state, default_state["Link149"])

	@property
	def Link150(self):
		self._getter_access_tracker["Link150"] = {}
		return self._Link150
	@Link150.setter
	def Link150(self, new_state):
		self._setter_access_tracker["Link150"] = {}
		global default_state
		self._Link150 = Link(new_state, default_state["Link150"])
	...
	def _to_json_fields(self):
		return {
			...
			"Link147": self._Link147,
			"Link148": self._Link148,
			"Link149": self._Link149,
			"Link150": self._Link150,
