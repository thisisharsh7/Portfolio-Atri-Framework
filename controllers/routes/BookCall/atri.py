...
class Atri:
	def __init__(self, state: Any):
		...
		self.Link200 = state["Link200"]
		self.Link201 = state["Link201"]
		self.Link202 = state["Link202"]
		self.TextBox355 = state["TextBox355"]
		self.TextBox356 = state["TextBox356"]
		self.TextBox357 = state["TextBox357"]
		self.Link203 = state["Link203"]
		self.TextBox358 = state["TextBox358"]
		self.Link204 = state["Link204"]
		self.TextBox359 = state["TextBox359"]
		self.Link205 = state["Link205"]
		self.TextBox360 = state["TextBox360"]
		self.Link191 = state["Link191"]
		self.Link192 = state["Link192"]
		self.Link193 = state["Link193"]
		self.Link194 = state["Link194"]
		self.Link195 = state["Link195"]
		self.Link196 = state["Link196"]
		self.Link197 = state["Link197"]
		self.Link198 = state["Link198"]
		self.Link199 = state["Link199"]
	...
	@property
	def Link200(self):
		self._getter_access_tracker["Link200"] = {}
		return self._Link200
	@Link200.setter
	def Link200(self, new_state):
		self._setter_access_tracker["Link200"] = {}
		global default_state
		self._Link200 = Link(new_state, default_state["Link200"])

	@property
	def Link201(self):
		self._getter_access_tracker["Link201"] = {}
		return self._Link201
	@Link201.setter
	def Link201(self, new_state):
		self._setter_access_tracker["Link201"] = {}
		global default_state
		self._Link201 = Link(new_state, default_state["Link201"])

	@property
	def Link202(self):
		self._getter_access_tracker["Link202"] = {}
		return self._Link202
	@Link202.setter
	def Link202(self, new_state):
		self._setter_access_tracker["Link202"] = {}
		global default_state
		self._Link202 = Link(new_state, default_state["Link202"])
	...
	@property
	def Link203(self):
		self._getter_access_tracker["Link203"] = {}
		return self._Link203
	@Link203.setter
	def Link203(self, new_state):
		self._setter_access_tracker["Link203"] = {}
		global default_state
		self._Link203 = Link(new_state, default_state["Link203"])
	...
	@property
	def Link204(self):
		self._getter_access_tracker["Link204"] = {}
		return self._Link204
	@Link204.setter
	def Link204(self, new_state):
		self._setter_access_tracker["Link204"] = {}
		global default_state
		self._Link204 = Link(new_state, default_state["Link204"])
	...
	@property
	def Link205(self):
		self._getter_access_tracker["Link205"] = {}
		return self._Link205
	@Link205.setter
	def Link205(self, new_state):
		self._setter_access_tracker["Link205"] = {}
		global default_state
		self._Link205 = Link(new_state, default_state["Link205"])
	...
	@property
	def Link191(self):
		self._getter_access_tracker["Link191"] = {}
		return self._Link191
	@Link191.setter
	def Link191(self, new_state):
		self._setter_access_tracker["Link191"] = {}
		global default_state
		self._Link191 = Link(new_state, default_state["Link191"])

	@property
	def Link192(self):
		self._getter_access_tracker["Link192"] = {}
		return self._Link192
	@Link192.setter
	def Link192(self, new_state):
		self._setter_access_tracker["Link192"] = {}
		global default_state
		self._Link192 = Link(new_state, default_state["Link192"])

	@property
	def Link193(self):
		self._getter_access_tracker["Link193"] = {}
		return self._Link193
	@Link193.setter
	def Link193(self, new_state):
		self._setter_access_tracker["Link193"] = {}
		global default_state
		self._Link193 = Link(new_state, default_state["Link193"])

	@property
	def Link194(self):
		self._getter_access_tracker["Link194"] = {}
		return self._Link194
	@Link194.setter
	def Link194(self, new_state):
		self._setter_access_tracker["Link194"] = {}
		global default_state
		self._Link194 = Link(new_state, default_state["Link194"])

	@property
	def Link195(self):
		self._getter_access_tracker["Link195"] = {}
		return self._Link195
	@Link195.setter
	def Link195(self, new_state):
		self._setter_access_tracker["Link195"] = {}
		global default_state
		self._Link195 = Link(new_state, default_state["Link195"])

	@property
	def Link196(self):
		self._getter_access_tracker["Link196"] = {}
		return self._Link196
	@Link196.setter
	def Link196(self, new_state):
		self._setter_access_tracker["Link196"] = {}
		global default_state
		self._Link196 = Link(new_state, default_state["Link196"])

	@property
	def Link197(self):
		self._getter_access_tracker["Link197"] = {}
		return self._Link197
	@Link197.setter
	def Link197(self, new_state):
		self._setter_access_tracker["Link197"] = {}
		global default_state
		self._Link197 = Link(new_state, default_state["Link197"])

	@property
	def Link198(self):
		self._getter_access_tracker["Link198"] = {}
		return self._Link198
	@Link198.setter
	def Link198(self, new_state):
		self._setter_access_tracker["Link198"] = {}
		global default_state
		self._Link198 = Link(new_state, default_state["Link198"])

	@property
	def Link199(self):
		self._getter_access_tracker["Link199"] = {}
		return self._Link199
	@Link199.setter
	def Link199(self, new_state):
		self._setter_access_tracker["Link199"] = {}
		global default_state
		self._Link199 = Link(new_state, default_state["Link199"])
	...
	def _to_json_fields(self):
		return {
			...
			"Link200": self._Link200,
			"Link201": self._Link201,
			"Link202": self._Link202,
			"TextBox355": self._TextBox355,
			"TextBox356": self._TextBox356,
			"TextBox357": self._TextBox357,
			"Link203": self._Link203,
			"TextBox358": self._TextBox358,
			"Link204": self._Link204,
			"TextBox359": self._TextBox359,
			"Link205": self._Link205,
			"TextBox360": self._TextBox360,
			"Link191": self._Link191,
			"Link192": self._Link192,
			"Link193": self._Link193,
			"Link194": self._Link194,
			"Link195": self._Link195,
			"Link196": self._Link196,
			"Link197": self._Link197,
			"Link198": self._Link198,
			"Link199": self._Link199,
